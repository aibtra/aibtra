...
internal class RefinerTextTab(private val workingMode: WorkingMode, tabbedPane: MainTabbedPane, environment: Environment, dialogDisplayer: DialogDisplayer) : RefinerTextualTab(workingMode, tabbedPane, environment, dialogDisplayer) {
	...
	override fun addSchemeActions(menu: JMenu) : Boolean {
		...
		addAction(onPasteMenu, RefinerTextNormalizerAction.createChangeDoubleToSingleBlockQuotes(environment.configurationProvider, environment.accelerators))
		addAction(onPasteMenu, RefinerTextNormalizerAction.createFixMissingEmptyLineAfterBlockQuote(environment.configurationProvider, environment.accelerators))
		addAction(onPasteMenu, RefinerTextNormalizerAction.createRewrapBlockQuotes(environment.configurationProvider, environment.accelerators))
