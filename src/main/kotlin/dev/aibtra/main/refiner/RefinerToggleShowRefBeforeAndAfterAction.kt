...
class RefinerToggleShowRefBeforeAndAfterAction(
	diffManager: RefinerDiffManager,
	profileManager: RefinerProfileManager,
	accelerators: Accelerators
) :
	RefinerMainMenuProfileBooleanAction("toggleShowRefBeforeAndAfter", "Show Diff Before/After", Icons.SHOW_REMOVED, "Before/After", null, accelerators,
		profileManager,
