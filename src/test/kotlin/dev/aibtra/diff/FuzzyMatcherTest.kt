...
class FuzzyMatcherTest {
	...
	fun testRandomLinesLarge() {
		...
		assertMatch(text, block, blockPos)
	}

	private fun assertMatch(haystack: String, needle: String, expectedPos: Int) {
		val matcher = FuzzyMatcher(errorThreshold, errorRatio)
		val actualPos = matcher.findBestMatch(haystack, needle, startPos)
