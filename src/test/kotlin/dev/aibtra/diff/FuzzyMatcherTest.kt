...
class FuzzyMatcherTest {
    ...
    """.trimIndent()
		val haystack = "  foo\n    bar\nbaz\n${content}\nqux"
		val needle = content
		assertMatch(haystack, needle, 18)
	}

	@Test
	fun testRandomLinesLarge1() {
		testRandomLinesLarge(0, 92700)
	}

	@Test
	fun testRandomLinesLarge2() {
		testRandomLinesLarge(1, 93172)
	}

	@Test
	fun testRandomLinesLarge3() {
		testRandomLinesLarge(2, 90927)
	}
